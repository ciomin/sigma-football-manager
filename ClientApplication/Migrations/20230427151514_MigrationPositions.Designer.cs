...
namespace ClientApplication.Migrations
{
    ...
    [Migration("20230427151514_MigrationPositions")]
    partial class MigrationPositions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            modelBuilder
                .UseCollation("Romanian_CI_AS")
                .HasAnnotation("ProductVersion", "7.0.5")
                .HasAnnotation("Relational:MaxIdentifierLength", 128);

            SqlServerModelBuilderExtensions.UseIdentityColumns(modelBuilder);

            modelBuilder.Entity("ClientApplication.Models.Administrator", b =>
                {
            ...
            modelBuilder.Entity("ClientApplication.Models.Award", b =>
                {
            ...
            modelBuilder.Entity("ClientApplication.Models.Formation", b =>
                {
            ...
            modelBuilder.Entity("ClientApplication.Models.League", b =>
                {
            ...
            modelBuilder.Entity("ClientApplication.Models.Manager", b =>
                {
            ...
            modelBuilder.Entity("ClientApplication.Models.Match", b =>
                {
            ...
            modelBuilder.Entity("ClientApplication.Models.News", b =>
                {
            ...
            modelBuilder.Entity("ClientApplication.Models.Player", b =>
                {
                    b.Property<int>("PlayerId")
                        .HasColumnType("int")
                        .HasColumnName("player_id");
            ...
            modelBuilder.Entity("ClientApplication.Models.Referee", b =>
                {
                    b.Property<int>("RefereeId")
                        .HasColumnType("int")
                        .HasColumnName("referee_id");
            ...
            modelBuilder.Entity("ClientApplication.Models.Scorer", b =>
                {
            ...
            modelBuilder.Entity("ClientApplication.Models.Squad", b =>
                {
            ...
            modelBuilder.Entity("ClientApplication.Models.Stadium", b =>
                {
                    b.Property<int>("StadiumId")
                        .HasColumnType("int")
                        .HasColumnName("stadium_id");
            ...
            modelBuilder.Entity("ClientApplication.Models.Standing", b =>
                {
            ...
            modelBuilder.Entity("ClientApplication.Models.TeamContract", b =>
                {
            ...
            modelBuilder.Entity("ClientApplication.Models.Transfer", b =>
                {
            ...
            modelBuilder.Entity("ClientApplication.Models.User", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int")
                        .HasColumnName("user_id");
            ...
            modelBuilder.Entity("ClientApplication.Models.Award", b =>
                {
                    b.HasOne("ClientApplication.Models.Player", "Player")
                        .WithMany("Awards")
            ...
            modelBuilder.Entity("ClientApplication.Models.Match", b =>
                {
                    b.HasOne("ClientApplication.Models.User", "AwayTeam")
                        .WithMany("MatchAwayTeams")
                        .HasForeignKey("AwayTeamId")
                        .IsRequired()
                        .HasConstraintName("FK_Matches_Users_Awayteam");

                    b.HasOne("ClientApplication.Models.User", "HomeTeam")
                        .WithMany("MatchHomeTeams")
                        .HasForeignKey("HomeTeamId")
                        .IsRequired()
                        .HasConstraintName("FK_Matches_Users_Hometeam");

                    b.HasOne("ClientApplication.Models.Referee", "Referee")
                        .WithMany("Matches")
                        .HasForeignKey("RefereeId")
                        .HasConstraintName("FK_Matches_Referees");

                    b.HasOne("ClientApplication.Models.Stadium", "Stadium")
                        .WithMany("Matches")
            ...
            modelBuilder.Entity("ClientApplication.Models.News", b =>
                {
                    b.HasOne("ClientApplication.Models.Administrator", "Admin")
                        .WithMany("News")
            ...
            modelBuilder.Entity("ClientApplication.Models.Player", b =>
                {
                    b.HasOne("ClientApplication.Models.League", "League")
                        .WithMany("Players")
            ...
            modelBuilder.Entity("ClientApplication.Models.Squad", b =>
                {
                    b.HasOne("ClientApplication.Models.User", "User")
                        .WithMany("Squads")
            ...
            modelBuilder.Entity("ClientApplication.Models.TeamContract", b =>
                {
                    ...
                    b.HasOne("ClientApplication.Models.Squad", "Squad")
                        .WithMany("TeamContracts")
            ...
            modelBuilder.Entity("ClientApplication.Models.Transfer", b =>
                {
                    b.HasOne("ClientApplication.Models.User", "BuyingUser")
                    ...
                    b.HasOne("ClientApplication.Models.User", "SellingUser")
